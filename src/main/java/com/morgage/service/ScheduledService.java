...
//        for (Transaction transaction : list) {
//            transaction.setStatus(Const.TRANSACTION_STATUS.LATE);
...
//                String count = entry.getValue().toString();
//                int shopId = Integer.parseInt(entry.getKey().toString());
//                notificationService.createNotification(count + env.getProperty("notification.shop.late"), Const.NOTIFICATION_TYPE.SYSTEM_SHOP, null, shopId, shopId);
//            }
//            shopCountNotification.clear();
//        }
//    }
